 ...
 * Generated at: 2018-12-19 13:09:46 UTC
...
public final class create_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${context}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/resources/bower_components/tinymce/tinymce.min.js\"></script>\r\n");
      out.write(" <!-- jquery load -->\r\n");
      out.write("\r\n");
      out.write(" <script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${context}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/resources/bower_components/jquery/dist/jquery.js\"></script>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("<script>\r\n");
      ...
      out.write("\t\t    plugins : \"autolink autosave code link media image table textcolor autoresize\",\r\n");
      out.write("\t\t\ttoolbar: \"mybutton | undo redo | forecolor bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | table link media custom_image code \",\r\n");
      out.write("\t\t    \r\n");
      out.write("\t\t    setup: function(editor) {\r\n");
      out.write("\t\t        editor.addButton('mybutton', {\r\n");
      out.write("\t\t            text:\"IMG\",\r\n");
      out.write("\t\t            icon: false,\r\n");
      out.write("\t\t            onclick: function(e) {\r\n");
      out.write("\t\t\t                console.log($(e.target));\r\n");
      out.write("\t\t\t                //\tBUTTON\r\n");
      out.write("\t\t\t                if($(e.target).prop(\"tagName\") == 'BUTTON'){\r\n");
      out.write("\t\t\t\t\t\t\t\tconsole.log($(e.target).parent().parent().find('input').attr('id'));                    \r\n");
      out.write("\t\t\t\t\t\t\t\tif($(e.target).parent().parent().find('input').attr('id') != 'tinymce-uploader') {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(e.target).parent()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.parent()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t.append('<input id=\"tinymce-uploader\" type=\"file\" name=\"pic\" accept=\"image/*\" style=\"display:none\">');\r\n");
      out.write("\t\t\t\t                }\r\n");
      out.write("\t\t\t\t                $('#tinymce-uploader').trigger('click');\r\n");
      out.write("\t\t\t\t                $('#tinymce-uploader').change(function(){\r\n");
      out.write("\t\t\t\t                 \tvar input, file, fr, img;\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t            if (typeof window.FileReader !== 'function') {\r\n");
      out.write("\t\t\t\t\t\t                write(\"The file API isn't supported on this browser yet.\");\r\n");
      out.write("\t\t\t\t\t\t                return;\r\n");
      out.write("\t\t\t\t\t\t            }\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t            input = document.getElementById('tinymce-uploader');\r\n");
      out.write("\t\t\t\t\t\t            \r\n");
      out.write("\t\t\t\t\t\t            if (!input) {\r\n");
      out.write("\t\t\t\t\t\t                write(\"Um, couldn't find the imgfile element.\");\r\n");
      out.write("\t\t\t\t\t\t            }\r\n");
      out.write("\t\t\t\t\t\t            else if (!input.files) {\r\n");
      out.write("\t\t\t\t\t\t                write(\"This browser doesn't seem to support the `files` property of file inputs.\");\r\n");
      out.write("\t\t\t\t\t\t            }\r\n");
      out.write("\t\t\t\t\t\t            else if (!input.files[0]) {\r\n");
      out.write("\t\t\t\t\t\t                write(\"Please select a file before clicking 'Load'\");\r\n");
      out.write("\t\t\t\t\t\t            }\r\n");
      out.write("\t\t\t\t\t\t            else {\r\n");
      out.write("\t\t\t\t\t\t                file = input.files[0];\r\n");
      out.write("\t\t\t\t\t\t                fr = new FileReader();\r\n");
      out.write("\t\t\t\t\t\t                fr.onload = createImage;\r\n");
      out.write("\t\t\t\t\t\t                fr.readAsDataURL(file);\r\n");
      out.write("\t\t\t\t\t\t            }\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t            function createImage() {\r\n");
      out.write("\t\t\t\t\t\t                img = new Image();\r\n");
      out.write("\t\t\t\t\t\t                img.src = fr.result;\r\n");
      out.write("\t\t\t\t\t\t                editor.insertContent('<img src=\"'+img.src+'\"/>');\r\n");
      out.write("\t\t\t\t\t\t            }\r\n");
      out.write("\t\t\t\t                });\r\n");
      out.write("\t\t\t            }\r\n");
      out.write("\t\t\t                \r\n");
      out.write("\t\t\t                \r\n");
      out.write("\t\t\t           //\tDIV\r\n");
      out.write("\t\t\t            if($(e.target).prop(\"tagName\") == 'DIV'){\r\n");
      out.write("\t\t\t\t           \tif($(e.target).parent().find('input').attr('id') != 'tinymce-uploader') {\r\n");
      out.write("\t\t\t\t \t\t\t\tconsole.log($(e.target).parent().find('input').attr('id'));                                \r\n");
      out.write("\t\t\t\t                $(e.target).parent().append('<input id=\"tinymce-uploader\" type=\"file\" name=\"pic\" accept=\"image/*\" style=\"display:none\">');\r\n");
      out.write("\t\t\t\t            }\r\n");
      out.write("\t\t\t\t           \t\r\n");
      out.write("\t\t\t                $('#tinymce-uploader').trigger('click');\r\n");
      out.write("\t\t\t                $('#tinymce-uploader').change(function(){\r\n");
      ...
      out.write("\t\t\t           }\r\n");
      out.write("\t\t\t           //\tI\r\n");
      out.write("\t\t\t           if($(e.target).prop(\"tagName\") == 'I'){\r\n");
      out.write("\t\t\t\t\t\t\tconsole.log($(e.target).parent().parent().parent().find('input').attr('id'));\r\n");
      out.write("\t\t\t\t\t\t\tif($(e.target).parent().parent().parent().find('input').attr('id') != 'tinymce-uploader') {\r\n");
      out.write("\t\t\t\t\t\t\t\t$(e.target).parent()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t.parent()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t.parent()\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t.append('<input id=\"tinymce-uploader\" type=\"file\" name=\"pic\" accept=\"image/*\" style=\"display:none\">');\r\n");
      ...
      out.write("<body>\r\n");
      out.write("\t<br>\r\n");
      out.write("\t<h2 class=\"mt-5 mb-4\"> POSTING </h2>\r\n");
      out.write("\t\r\n");
      out.write("\t");
      //  form:form
      ...
      try {
        ...
        // /WEB-INF/views/create.jsp(183,1) name = commandName type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_form_005fform_005f0.setCommandName("hboard");
          ...
          if (_jspx_eval_form_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              try {
                ...
                // /WEB-INF/views/create.jsp(188,3) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              out.write("\t\t\r\n");
              out.write("\t\t<div class=\"md-form\">\r\n");
              out.write("\t\t\t<label> SubTitle</label>\r\n");
              out.write("\t\t\t");
              ...
              try {
                ...
                // /WEB-INF/views/create.jsp(194,3) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                _jspx_th_form_005ferrors_005f1.setPath("subtitle");
              ...
              out.write("\t\t\t<label>WRITER : TONZ</label>\r\n");
              out.write("\t\t</div>\r\n");
              out.write("\t\t\r\n");
              out.write("\t\t\r\n");
              out.write("\t\t\r\n");
              ...
              out.write("\t\t\t<button type=\"submit\" class=\"btn btn-unique btn-md\">\r\n");
              out.write("\t\t\t\t<i class=\"fas fa-check mr-2\"></i> CHECH</button>\r\n");
              out.write("\t\t\t<a href=\"#\" onclick=\"history.back()\" class=\"btn btn-unique btn-md\">\r\n");
              out.write("\t\t\t\t<i class=\"fas fa-undo mr-2\"></i> BACK</a>\r\n");
              out.write("\r\n");
              out.write("\t\t</div>\r\n");
              out.write("\t\t\r\n");
              out.write("\t");
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/create.jsp(7,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("context");
      // /WEB-INF/views/create.jsp(7,0) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/create.jsp(7,0) '${pageContext.request.contextPath}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${pageContext.request.contextPath}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/views/create.jsp(7,0) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005finput_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/create.jsp(187,3) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_form_005finput_005f0.setPath("title");
      // /WEB-INF/views/create.jsp(187,3) null
  ...
  private boolean _jspx_meth_form_005finput_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/create.jsp(193,3) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_form_005finput_005f1.setPath("subtitle");
      // /WEB-INF/views/create.jsp(193,3) null
  ...
  private boolean _jspx_meth_form_005ftextarea_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/create.jsp(204,2) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
