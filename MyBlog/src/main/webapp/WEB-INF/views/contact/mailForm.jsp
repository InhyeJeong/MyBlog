...
<div class="container">
	<div class="row">
		<div class="col-lg-8 col-md-10 mx-auto">
			...
			<form:form commandName="mailInfo"
			action="${pageContext.request.contextPath}/contact/mailSend"
				method="post" name="sentMessage" id="contactForm" >
				...
				<div class="control-group">
					<div
						...
						<label>Phone Number</label> <input type="tel" name="phoneNumber" class="form-control"
				...
				<div class="control-group">
					<div class="form-group floating-label-form-group controls">
						<label>Message</label>
						<textarea name="message" rows="5" cols="30" class="form-control"
