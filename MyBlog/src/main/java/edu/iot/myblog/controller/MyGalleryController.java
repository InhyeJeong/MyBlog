...
public class MyGalleryController {
	...
	//	updateSubmit에서 사진추가하고 submit 눌렀을 때
	...
	public String addImagesSubmit(MyGalleryImage image, MultipartHttpServletRequest request,
		...
		return "redirect:/gallery/list";//	업로드를 완료하면 list로 바로 가도록 리다이렉트
	}
...
//		ImageUtil.saveThumb(dest);
	...
	public String image (
		...
		/**위에서 @Autowired 로 context를 얻고 어플리케이션 객체의 getMimeType메서드를 이용*/
